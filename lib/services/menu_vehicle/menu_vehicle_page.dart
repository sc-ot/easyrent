...
import 'menu_vehicle_provider.dart';
...
class MenuVehiclePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    MenuVehicleProvider menuVehicleProvider =
    ...
    return MenuPageContainer(
      ...
      Column(
        children: [
          ...
          menuVehicleProvider.ui == STATE.SUCCESS
              ? Expanded(
                  child: Padding(
                    ...
                    child: RefreshIndicator(
                      ...
                      onRefresh: () => Future.sync(
                          () => menuVehicleProvider.pagingController.refresh()),
                      child: PagedListView<int, Vehicle>(
                        scrollController: menuVehicleProvider.scrollController,
                        shrinkWrap: true,
                        pagingController: menuVehicleProvider.pagingController,
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        top: 16.0, bottom: 12),
                                    child: Text(
                                      "Es wurden keine passenden Fahrzeuge für „${menuVehicleProvider.vehicleSearchFieldController.text}“ gefunden",
                                      style:
                                          Theme.of(context).textTheme.bodyText1,
                                      textAlign: TextAlign.center,
                                    ),

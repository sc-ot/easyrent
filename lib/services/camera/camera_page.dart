...
class CameraPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<CameraPicture> images = args is List<CameraPicture> ? args : [];
    return ChangeNotifierProvider(
      create: (BuildContext context) => CameraProvider(images: images),
            ...
            child: FutureBuilder<void>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.done) {
                  print("--");
                  print("Aktuelles Bild: " +
                      (cameraProvider.currentImageIndex + 1).toString());
                  print("Bilderanzahl: " +
                      cameraProvider.images.length.toString());
                        ...
                        children: [
                          LayoutBuilder(
                            builder: (context, constraints) {
                              return Listener(
                                onPointerDown: (_) => cameraProvider.pointers++,
                                onPointerUp: (_) => cameraProvider.pointers--,
                                child: GestureDetector(
                                  behavior: HitTestBehavior.opaque,
                                  onScaleStart: cameraProvider.handleScaleStart,
                                  onScaleUpdate:
                                      cameraProvider.handleScaleUpdate,
                                  onTapDown: (details) => cameraProvider
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    cameraProvider
                                        .images[
                                            cameraProvider.currentImageIndex]
                                        .tag,
